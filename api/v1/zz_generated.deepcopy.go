...
func (in *ServicesConfig) DeepCopyInto(out *ServicesConfig) {
	*out = *in
	...
	if in.DevopsAPI != nil {
		in, out := &in.DevopsAPI, &out.DevopsAPI
		*out = new(ServiceConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.DevopsManagerRPC != nil {
		in, out := &in.DevopsManagerRPC, &out.DevopsManagerRPC
		*out = new(ServiceConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.DevopsPipelineRPC != nil {
		in, out := &in.DevopsPipelineRPC, &out.DevopsPipelineRPC
		*out = new(ServiceConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.DevopsQualityRPC != nil {
		in, out := &in.DevopsQualityRPC, &out.DevopsQualityRPC
		*out = new(ServiceConfig)
		(*in).DeepCopyInto(*out)
	}
}
